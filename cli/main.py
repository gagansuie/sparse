...
def cmd_pack(args):
    ...
    baseline_ppl = compute_ppl(model, tokenizer, eval_texts, device, max_samples=args.eval_samples)
    ...
    compressed_ppl = compute_ppl(model, tokenizer, eval_texts, device, max_samples=args.eval_samples)
...
def cmd_eval(args):
    ...
    ppl = compute_ppl(model, tokenizer, texts, device, max_samples=args.samples)
